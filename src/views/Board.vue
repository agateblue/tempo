          ...
          <v-card-text v-if="lists[idx].expanded" class="py-2 px-2">
            <v-card v-if="lists[idx].showForm" :color="$theme.nestedCard.color">
              ...
              <v-card-actions class="py-4 px-0">
                <v-row>
                  <v-col class="ml-3">
                    <v-btn :transition="null" class="float-left" text @click.prevent="lists[idx].showForm = false">
                      Cancel
                    </v-btn>
                  </v-col>
                  <v-col class="mr-4">
                    <v-btn :transition="null" class="float-right" color="primary" @click.prevent="submitTask(idx)">
                      Add
                    </v-btn>
                  </v-col>
                </v-row>
